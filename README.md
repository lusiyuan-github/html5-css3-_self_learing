...
```html
<table border="1" cellspacing = "0"><!--一个表格，border="1"有边框，cellspacing = "0"边框间距为0，还可设置width和height-->
    <thead><!--表格头部标签-->
    	<tr><!--表格中的一行-->
        	<th>单元格里的文字</th><!--表头标签table head，文字会居中加粗-->
    	</tr>    
    </thead>
    <tbody><!--表格主体标签-->
    	<tr><!--表格中的一行-->
        	<td>单元格里的文字</td><!--一行中的单元格-->
   	 	</tr>
    </tbody>
